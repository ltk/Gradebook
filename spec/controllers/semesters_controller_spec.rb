...
describe SemestersController do
  ...
  def valid_attributes
    { "start_date" => "2012-08-01", "end_date" => "2012-12-01", "name" => "Fall 2012" }
  end
    ...
    describe "POST create" do
      ...
      describe "with invalid params" do
        it "assigns a newly created but unsaved semester as @semester" do
          ...
          post :create, {:semester => { "courses_count" => "invalid value" }}, valid_session
          assigns(:semester).should be_a_new(Semester)
        end
    ...
    describe "PUT update" do
      describe "with valid params" do
        it "updates the requested semester" do
          ...
          Semester.any_instance.should_receive(:update_attributes).with({ "courses_count" => "1" })
          put :update, {:id => semester.to_param, :semester => { "courses_count" => "1" }}, valid_session
        end
      ...
      describe "with invalid params" do
        it "assigns the semester as @semester" do
          ...
          # Trigger the behavior that occurs when invalid params are submitted
          Semester.any_instance.stub(:save).and_return(false)
          put :update, {:id => semester.to_param, :semester => { "courses_count" => "invalid value" }}, valid_session
          assigns(:semester).should eq(semester)
        end
