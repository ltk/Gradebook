  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved enrollment as @enrollment" do
        ...
        post :create, {:enrollment => { "student_id" => "invalid value" }}, valid_session
        assigns(:enrollment).should be_a_new(Enrollment)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested enrollment" do
        ...
        Enrollment.any_instance.should_receive(:update_attributes).with({ "student_id" => "1" })
        put :update, {:id => enrollment.to_param, :enrollment => { "student_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the enrollment as @enrollment" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Enrollment.any_instance.stub(:save).and_return(false)
        put :update, {:id => enrollment.to_param, :enrollment => { "student_id" => "invalid value" }}, valid_session
        assigns(:enrollment).should eq(enrollment)
      end
